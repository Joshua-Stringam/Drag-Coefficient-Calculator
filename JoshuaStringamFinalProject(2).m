...
Velocity= 2830 * 0.3048; %m/s
Cd= .5; %1st guess 
m= 220*0.000064799;%Projectile Mass in kg (Grains conversion)
d=0.300; %Calibre in fractions of an inch
...
P=PMAX;%Specify desired number of Iterations
            ...
            xm=[0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200];
            ym=[-2, 20.2, 37.1, 48.6, 54.2, 52.9, 44.2, 26.9, 0, -37.8, -88, -152.4, -233];
...
%%for p=1:P
    %Time Loop
    tfinal=3; %Calculation Duration Seconds
...
title('Drop Chart Data 0.300 calibre, 220 Grain 2830ft/s')
